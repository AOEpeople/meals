...
- adds option to mail via rest api (1894623c)
...
- fix linter errors (4675f24b)
- fix linter errors (814700d0)
...
- **deps-dev:** bump baseline-browser-mapping in /src/Resources (07f3cd64)
- **deps:** bump postcss-selector-parser in /src/Resources (77bab17f)
- **deps:** bump docker/login-action from 4.5.2 to 4.6.0 (c3d991ec)
- **deps:** bump svgo from 4.0.2 to 4.1.0 in /src/Resources (0af7c44c)
- **deps-dev:** bump vitest from 4.1.8 to 4.1.11 in /src/Resources (0a960c0a)
- **deps:** bump js-yaml from 4.3.1 to 4.3.2 in /src/Resources (e01f536d)
- **deps:** bump form-data from 4.0.4 to 4.0.6 in /tests/e2e (a8bc090f)
- **deps:** bump actions/checkout from 6 to 7 (eb5c2d78)
- **deps-dev:** bump browserslist in /src/Resources (c4f71d5f)
- **deps:** bump fflate from 0.8.2 to 0.8.3 in /src/Resources (9a95dd11)
- **deps:** bump form-data from 4.0.5 to 4.0.6 in /src/Resources (24d8be0f)
- **deps:** bump actions/cache from 5 to 6 (f7cabb89)
- **deps-dev:** bump brace-expansion in /src/Resources (1ae6c9d7)
...
- fixes phpmd (d7d64097)
- add ONLY_FULL_GROUP_BY to sql_mode (7aac84a5)
- fixes code-style (627ca554)

### Other

- enforce TSL v1.2 (01df5cad)
