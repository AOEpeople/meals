...
final class KitchenStaffParticipantControllerTest extends AbstractControllerTestCase
{
    ...
    public function testGetParticipationsForWeek(): void
    {
        ...
        $this->client->request('GET', '/api/participations/' . (string) $weekEntity->getId());
    ...
    public function testAddParticipant(): void
    {
        ...
        $routeStr = '/api/participation/' . (string) $profileToAdd->getId() . '/' . (string) $mealToAdd->getId();
    ...
    public function testRemoveParticipant(): void
    {
        ...
        $routeStr = '/api/participation/' . (string) $profile->getId() . '/' . (string) $meal->getId();
    ...
    public function testGetProfilesWithoutParticipation(): void
    {
        ...
        $routeStr = '/api/participations/' . (string) $weekEntity->getId() . '/abstaining';
    ...
    protected function getCurrentWeekParticipations(): Crawler
    {
        ...
        $crawler = $this->client->request('GET', '/participations/' . (string) $currentWeek->getId() . '/edit');
