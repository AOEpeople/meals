...
class ParticipationCountServiceTest extends AbstractParticipationServiceTest
{
    ...
    public function participationCountIsEmptyForEmptyDay(): void
    {
        ...
        $participation = (new \App\Mealz\MealBundle\Service\ParticipationCountService)->getParticipationByDay($day);
    ...
    public function participationCountForNotLockedNotExpiredMeal(): void
    {
        ...
        $participation = (new \App\Mealz\MealBundle\Service\ParticipationCountService)->getParticipationByDay($weekDay);
    ...
    public function participationCountForCombinedMealWithoutParticipants(): void
    {
        ...
        $participation = (new \App\Mealz\MealBundle\Service\ParticipationCountService)->getParticipationByDay($combinedMeal->getDay());
        $this->checkParticipationByDay($participation, $meals);
    }
    ...
    public function participationCountIsEmptyForEmptyWeek(): void
    {
        ...
        $participation = (new \App\Mealz\MealBundle\Service\ParticipationCountService)->getParticipationByDays($currentWeek);
        $this->assertEmpty($participation);
    }
    ...
    private function getAndCheckParticipationByDays(MealCollection $meals): array
    {
        ...
        $participations = (new \App\Mealz\MealBundle\Service\ParticipationCountService)->getParticipationByDays($week);
