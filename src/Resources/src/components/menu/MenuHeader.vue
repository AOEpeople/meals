<template>
  <div class="grid w-full grid-cols-[minmax(0,2fr)_minmax(0,1fr)] grid-rows-2 gap-4">
    <h2 class="col-start-1 row-span-2 row-start-1 w-full self-center justify-self-start">
