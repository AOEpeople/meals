...
describe('Test getShowParticipations', () => {
    ...
    it('should return a list of bookable meals', async () => {
        ...
        const TESTCASES = ["Century Eggs, paired with a compote of seasonal berries and rye bread #v1", "Century Eggs, paired with a compote of seasonal berries and rye bread #v2", "Tasty Worms", "Combined Dish"];
    ...
    it('should return a list of all meals', async () => {
        ...
        const TESTCASES = ["Century Eggs, paired with a compote of seasonal berries and rye bread", "Tasty Worms", "Combined Dish"];
        const TEST_VARIATIONS = ["Century Eggs, paired with a compote of seasonal berries and rye bread #v1", "Century Eggs, paired with a compote of seasonal berries and rye bread #v2"];
